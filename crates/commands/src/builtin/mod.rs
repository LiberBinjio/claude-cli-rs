...
// CROSS-DEP: dev2 — the following modules are implemented by dev2 in T08.
// Uncomment once dev2's files are ready:
// pub mod exit;
// pub mod clear;
// pub mod version;
// pub mod status;
...
pub fn register_builtins(registry: &mut CommandRegistry) {
    ...
    // CROSS-DEP: dev2 — register these once their modules compile:
